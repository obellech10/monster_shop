...
#       @sal = User.create!(name: 'Sals Salamanders', address: '125 Main St', city: 'Denver', state: 'CO', zip: 80218, user_name: "sal@gmail.com", password: "test", user_name: "iamgmail.com", password: "test", role: 2)
