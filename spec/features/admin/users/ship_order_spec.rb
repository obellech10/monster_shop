...
RSpec.describe 'Admin can ship an order' do
  describe 'As an admin user, when I log into my dashboard, /admin/dashboard' do
    before :each do
      @user_1 = User.create!(name: "Diane", address: "1331 Main St.", city: "Denver", state: "CO", zip: 80202, user_name: "diane@gmail.com", password: "test", role: "default")
      @user_2 = User.create!(name: "Sam", address: "1331 Main St.", city: "Denver", state: "IA", zip: 80202, user_name: "sam@gmail.com", password: "test", role: "default")

      @admin = User.create!(name: "Jack", address: "1331 Main St.", city: "Denver", state: "CO", zip: 80202, user_name: "jack@gmail.com", password: "test", role: "admin")
      ...
      @order_3 = Order.create!(user: @user_1, status: "pending")
      ...
      @order_4 = Order.create!(user: @user_2, status: "pending")
    ...
    it "When I click that button for an order, the status of that order changes to shipped, and the user can no longer cancel the order." do
      ...
      expect(@order_2.reload.status).to eq("shipped")
    end
  end
end
