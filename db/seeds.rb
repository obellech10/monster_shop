...
lamp = brian.items.create!(name: 'Lamp', description: "I'm a Lamp!", price: 28, image: 'https://images.homedepot-static.com/productImages/967ebf56-03e4-48c3-90ea-43875341a53d/svn/rhodes-bronze-hampton-bay-table-lamps-hd09999tlbrzc-64_1000.jpg', active: false, inventory: 20 )
...
lisa = User.create!(name: "Lisa", address: "13 Tree St.", city: "Miami", state: "FL", zip: 34102, user_name: "lisa@gmail.com", password: "1234", role: 0)
joe = User.create!(name: "Joe", address: "200 25th Ave", city: "Atlanta", state: "GA", zip: 54372, user_name: "joe@gmail.com", password: "5678", role: 0)
